...
Example Usage:
`bash build.sh -r ~/rapids/cuxfilter -i gpuci/rapidsai-base:cuda10.1-ubuntu16.04-gcc5-py3.6`
...
The docker image will generate build artifacts in a folder on your machine located in the `root` directory of the repository you passed to the script. For the above example, the directory is named `~/rapids/cuxfilter/build_rapidsai-base_cuda10.1-ubuntu16.04-gcc5-py3.6/`. Feel free to remove this directory after the script is finished.
