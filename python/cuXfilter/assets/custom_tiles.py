...
Attributes:
    ...
    get_provider
        Use this function to retrieve an instance of a custom mapbox tile provider.
    ...
    MAPBOX_DARK
        ...
        .. raw:: html
            ...
            <img src="https://api.mapbox.com/styles/v1/mapbox/dark-v10/tiles/14/2627/6331@2x?access_token=pk.eyJ1IjoiZXhhbXBsZXMiLCJhIjoiY2p0MG01MXRqMW45cjQzb2R6b2ptc3J4MSJ9.zA2W0IkI0c6KaAhJfk9bWg" />
    ...
    STAMEN_TONER_LABELS
        ...
        .. raw:: html
            ...
            <img src="https://api.mapbox.com/styles/v1/mapbox/light-v10/tiles/14/2627/6331@2x?access_token=pk.eyJ1IjoiZXhhbXBsZXMiLCJhIjoiY2p0MG01MXRqMW45cjQzb2R6b2ptc3J4MSJ9.zA2W0IkI0c6KaAhJfk9bWg" />

Additional information available at:

* MAPBOX tile service - https://docs.mapbox.com/studio-manual/reference/tilesets/
...
class _TileProvidersModule(types.ModuleType):
    ...
    _SERVICE_URLS = dict(
        MAPBOX_DARK='https://api.mapbox.com/styles/v1/mapbox/dark-v10/tiles/{z}/{x}/{y}@2x?access_token=',
        MAPBOX_LIGHT='https://api.mapbox.com/styles/v1/mapbox/light-v10/tiles/{z}/{x}/{y}@2x?access_token='
    )
    ...
    def get_provider(self, provider_name, access_token=None):
        ...
        if isinstance(provider_name, WMTSTileSource):
            ...
            if provider_name.startswith('MAPBOX'):
                ...
                return WMTSTileSource(url=provider_name.url+str(access_token), attribution=provider_name.attribution)
        ...
        if selected_provider.startswith('MAPBOX'):
            ...
            if access_token is None:
                    raise ValueError('provide access token for MAPBOX tiles')
            return WMTSTileSource(url=url+str(access_token), attribution=attribution)
        else:
