...
def datasets_check(*args, base_dir='./'):
    ...
    #mortgage dataset
    url['mortgage']= 'https://s3.us-east-2.amazonaws.com/rapidsai-data/viz-data/146M_predictions_v2.arrow.gz'
    downloaded_filename['mortgage'] = dir_name+'/146M_predictions_v2.arrow.gz'
    ...
    #nyc taxi dataset
    url['nyc_taxi']= 'https://s3.amazonaws.com/nyc-tlc/trip+data/yellow_tripdata_2015-01.csv'
    ...
    url['auto_accidents']= 'https://s3.us-east-2.amazonaws.com/rapidsai-data/viz-data/auto_accidents.arrow.gz'
    downloaded_filename['auto_accidents'] = dir_name+'/auto_accidents.arrow.gz'
