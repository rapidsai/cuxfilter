...
def range_slider(x, width=400, height=20, data_points=100, step_size=None, step_size_type=int,  **params):
    return RangeSlider(x, width, height, data_points,step_size, step_size_type,  **params)

def int_slider(x, width=400, height=20, data_points=100, step_size=None, step_size_type=int,  **params):
    return IntSlider(x, width, height, data_points,step_size, step_size_type,  **params)

def float_slider(x, width=400, height=20, data_points=100, step_size=None, step_size_type=int,  **params):
