...
class DataTile:
    ...
    def __init__(
        self, active_chart: Type[BaseChart], passive_chart: Type[BaseChart],
        dtype: str = 'pandas', dimensions: int = 2, cumsum: bool = True
    ):
        '''
        init function
        '''
    ...
    def _calc_data_tile_for_size(self, data):
        ...
        return gpu_datatile.calc_data_tile_for_size(
            data.copy(), self.active_chart.x, self.active_chart.min_value,
            self.active_chart.max_value, self.active_chart.stride,
            cumsum=self.cumsum, return_format=self.dtype
        )
    ...
    def _calc_2d_data_tile(self, data):
        ...
        return gpu_datatile.calc_data_tile(
            data, self.active_chart, self.passive_chart,
